...
It uses the Boyer-Moore string search algorithm, which is really fast, even for an old 3,58 Mhz Z80. Amazing!
> TODO: It finds the first occurrence of a string into the line. We need to show all matches.
...
Devices, partitions (and their type), drive letters and device size (in Megabytes).

## nextdemo
It's a demo program for Nextor, so everyone can understand how almost Nextor routines can be used.
It's a menu-driven software.
...
# Version notes.
(c) 2020-2026 Brazilian MSX Crew. Some rights reserved, but it's released due to
...
Assembly because you think it's better*... I'd send your opinion to `/dev/null`.
